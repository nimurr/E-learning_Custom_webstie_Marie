...
import { FaPlay, FaChevronDown, FaLock, FaArrowDown } from 'react-icons/fa';
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 p-6">
            <div className="max-w-6xl mx-auto bg-white/90 backdrop-blur rounded-2xl shadow-md border p-6">
                ...
                <div className="bg-gray-50 border rounded-xl p-6 mb-8">
                    <p className="text-sm text-yellow-600 bg-yellow-200 py-1 px-5 rounded-full w-auto inline-block font-medium"> In Progress</p>
