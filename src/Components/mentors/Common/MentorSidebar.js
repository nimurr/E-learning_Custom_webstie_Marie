...
const menuItems = [
    {
        title: 'Dashboard',
        desc: 'Your main overview with profile progress and key stats',
        icon: '⭐',
        path: '/mentor',
    },
    {
        title: 'Revenue',
        desc: 'Track earnings, payouts, and financial performance',
        icon: '💵',
        path: '/mentor/revenue',
    },
    {
        title: 'Wallet',
        desc: 'View history of deposits, and withdrawals',
        icon: '💳',
        path: '/mentor/wallet',
    },
    {
        title: 'Reviews & Ratings',
        desc: 'View and respond to feedback from Propulsés',
        icon: '💎',
        path: '/mentor/reviews',
    },
    {
