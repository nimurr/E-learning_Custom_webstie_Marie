            ...
            <div className="">
                ...
                <div className="flex items-center justify-between mb-5">
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-lg font-bold text-indigo-800">Values</h1>
                    </div>
                    {isEditing ? (
                ...
                <div className="flex flex-wrap gap-2">
                    {values.map((item, i) => (
                        <div
                            key={i}
                            className="flex items-center gap-5 border border-gray-300 bg-white rounded-full px-4 py-3 shadow-sm"
                        >
                    ...
                    {values.length === 0 && (
                        <p className="text-sm text-gray-400 py-2">
                            No values added yet. Click Edit to add some.
                        </p>
                    )}
                </div>
