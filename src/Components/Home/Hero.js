...
const Hero = () => {
    return (
        <div className="h-screen w-full container mx-auto bg-no-repeat bg-cover bg-center pt-20 grid grid-cols-1 lg:grid-cols-2 items-center gap-10 px-5 xl:px-0 ">
            <div>
            ...
            <div className="lg:flex items-start justify-center hidden ">
                <img className="w-72 xl:min-w-96" src="/Images/Home/Hero/hero_position_top.png" alt="" />
                <img className="w-72 xl:min-w-96" src="/Images/Home/Hero/hero_position_bottom.png" alt="" />
            </div>
        </div>
    );
};
