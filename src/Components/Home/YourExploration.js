        ...
        <div className='lg:py-20 py-10 relative'>
            ...
            <div className='max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-5'>
                <div className='bg-blue-950/25 p-5 rounded-lg border border-orange-400/20'>
                    <h1 className='text-xl font-semibold text-white'>Parcours d'expédition</h1>
                    <p className='text-gray-300 mt-5 flex items-center gap-2'><span className='h-1.5 w-1.5 rounded-full inline-block bg-orange-400'></span>Un voyage structuré étape par étape</p>
                </div>
                <div className='bg-blue-950/25 p-5 rounded-lg border border-orange-400/20'>
                    <h1 className='text-xl font-semibold text-white'>Parcours d'expédition</h1>
                    <p className='text-gray-300 mt-5 flex items-center gap-2'><span className='h-1.5 w-1.5 rounded-full inline-block bg-orange-400'></span>Un voyage structuré étape par étape</p>
